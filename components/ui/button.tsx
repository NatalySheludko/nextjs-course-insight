    ...
    'inline-flex items-center justify-center whitespace-nowrap text-center text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50',
    {
        variants: {
            variant: {
                ...
                filled: 'font-medium w-[246px] text-base xl:text-lg xl:leading-[1.2] bg-(--frame) text-(--white) rounded-[40px] px-[99px] py-[16px] xl:w-full cursor-pointer',
                fill: 'font-medium text-[8px] xl:text-xs xl:leading-[1.2] bg-(--frame) text-(--white) rounded-[28px] px-[16px] py-[6px] w-auto cursor-pointer',
                outlined:
                ...
                outlinedDrop:
                    'font-medium text-lg leading-[1.2] border border-(--frame) w-full text-(--frame) rounded-[40px] px-[111px] py-[12px] h-[46px] bg-(--backgroundLightAlt) cursor-pointer',
                outline:
