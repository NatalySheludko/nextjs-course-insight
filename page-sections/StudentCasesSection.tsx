    ...
    return (
        <section className={cn('container')}>
            <div className="section">
                ...
                <div className="xl:flex xl:gap-[40px] bg-(--backgroundLight) rounded-[40px] p-[40px_20px] xl:p-[49px_40px_51px_50px]">
                    <Image
                    ...
                    <div>
                        <div className="relative">
                            ...
                            <div className="w-[305px] xl:w-[594px] mt-[24px] border-[1.5px] border-solid rounded-[16px] p-[40px_35px_41px_36px] xl:p-[71px_29px] backdrop-blur-[44px] bg-(--backgroundLightAlt) mb-[58px] ">
